...
CCofactorFinder::CCofactorFinder()
{
}

std::vector<std::vector<double>> CCofactorFinder::GetMatrixOfAlgebraicComplements(std::vector<std::vector<double>> matrix)
{
	m_matrix = matrix;
...
void CCofactorFinder::ShowMatrix(std::vector<std::vector<double>> matrix) const
{
...
double CCofactorFinder::GetMinor(std::vector<std::vector<double>> matrix, size_t x, size_t y)
{
	std::vector<std::vector<double>> minorMatrix = GetMatrixForMinor(matrix, x, y);
	return GetDeterminantOfMatrix(minorMatrix);
}

void CCofactorFinder::ShowMatrixOfAlgebraicComplements() const
{
...
std::vector<std::vector<double>> CCofactorFinder::GetMatrixForMinor(std::vector<std::vector<double>> matrix, size_t x, size_t y)
{
...
double CCofactorFinder::GetDeterminantOfMatrix(std::vector<std::vector<double>> matrix)
{
	if (matrix.size() == 2)
	{
